...
- 🔐 **Authentication** & user management via better-auth (self-hosted)

- 🏢 **Multi-tenant workspaces** with better-auth organization plugin (create, switch, manage teams)

- 💳 **Billing & subscriptions** with Stripe via @better-auth/stripe (plan management, feature gating)
...
| :--------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Signup / Signin                                                                                                                                                         | Authentication with **better-auth** provides secure, self-hosted authentication with email/password sign-in via better-auth-ui components.                                                                                                                             |
...
| [Billing & Plans](https://shadcn-dashboard.kiranism.dev/dashboard/billing)                                                                                             | Billing management page with custom shadcn UI showing plans and subscription management via Stripe. Requires an active organization.                                                                                                                                    |
| [Exclusive Page](https://shadcn-dashboard.kiranism.dev/dashboard/exclusive)                                                                                            | Example of plan-based access control using subscription checks. This page is only accessible to organizations on the Pro plan, demonstrating feature gating with fallback UI.                                                                                            |
...
For detailed instructions on configuring better-auth authentication (including organizations/workspaces/teams), please refer to [auth_setup.md](./docs/auth_setup.md).
