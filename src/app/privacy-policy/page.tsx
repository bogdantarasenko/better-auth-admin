      ...
      <div className='mx-auto max-w-3xl space-y-8'>
        ...
        <section>
          ...
          <p className='text-muted-foreground text-base leading-relaxed'>
            ...
            sign-in, and password management, are handled locally using this self-hosted auth
            library. Your authentication data is stored in the application database and is not shared
            with any third-party authentication service.
          </p>
        </section>
